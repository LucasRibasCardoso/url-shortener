package com.app.url_shortener.presentation.exception;
...
import com.app.url_shortener.domain.exception.conflict.ConflictException;
import com.app.url_shortener.domain.exception.notFound.NotFoundException;
import com.app.url_shortener.domain.exception.validation.DomainValidationException;
import java.net.URI;

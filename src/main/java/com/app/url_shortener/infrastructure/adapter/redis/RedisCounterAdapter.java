package com.app.url_shortener.infrastructure.adapter.redis;

import com.app.url_shortener.application.port.output.CounterIdRepository;
import org.springframework.data.redis.core.StringRedisTemplate;
import org.springframework.stereotype.Repository;

@Repository
public class RedisCounterAdapter implements CounterIdRepository {

  private static final String COUNTER_KEY = "url:counter:id";

  private final StringRedisTemplate redisTemplate;

  public RedisCounterAdapter(StringRedisTemplate redisTemplate) {
